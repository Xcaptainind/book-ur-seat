...
if 'DATABASE_URL' in os.environ:
    DATABASES['default']['OPTIONS'] = {
        'sslmode': 'require',
        'sslrootcert': os.path.join(BASE_DIR, 'render-ca.pem'),  # Optional for Render
    }

# Create render-ca.pem file for Render SSL
with open(os.path.join(BASE_DIR, 'render-ca.pem'), 'w') as f:
...
# Update security settings for Render
