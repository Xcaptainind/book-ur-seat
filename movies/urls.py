...
urlpatterns = [
    ...
    # path('theater/<int:theater_id>/razorpay-payment/', payment_views.razorpay_payment, name='razorpay_payment'),  # Commented out for now
    ...
    # path('webhook/razorpay/', payment_views.razorpay_webhook, name='razorpay_webhook'),  # Commented out for now
